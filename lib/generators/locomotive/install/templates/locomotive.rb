Locomotive.configure do |config|
  ...
  # default locale (for now, only en, de, fr, pl, pt-BR, it, nb, ja, zh-CN, cs, bg, sk and uk are supported)
  config.default_locale = :en

  # available locales suggested to "localize" a site. You will have to pick up at least one among that list.
  # config.site_locales = %w{en de fr pl pt-BR it nl nb es ru ja zh-CN cs bg sk sr uk}
