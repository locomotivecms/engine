...
describe Locomotive::Liquid::Filters::Html do
  ...
  it 'should return a link tag for a stylesheet file and the media attribute set to print' do
  ...
  it 'should return a link tag for a stylesheet file with folder and the media attribute set to print' do
  ...
  it 'should return a link tag for a stylesheet file without touching the url and the media attribute set to print' do
