class Page
  ...
  scope :minimal_attributes, :only => %w(title slug fullpath position depth published templatized redirect authentication_required listed parent_id created_at updated_at)
